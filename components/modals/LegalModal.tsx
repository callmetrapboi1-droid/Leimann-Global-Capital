...
export default function LegalModal({ isOpen, type, onClose }: LegalModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-surface-dim/80 backdrop-blur-md p-4 sm:p-6 animate-fadeIn">
      <div className="bg-surface text-on-surface max-w-2xl w-full max-h-[85vh] overflow-y-auto border border-gold/40 shadow-2xl relative p-8 sm:p-10 rounded-sm">
        <button
          onClick={onClose}
          className="absolute top-5 right-5 text-on-surface-variant hover:text-gold p-1.5 transition-colors"
          aria-label="Close"
        >
          <X className="w-6 h-6" />
        </button>

        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gold/40">
          <div className="w-9 h-9 bg-surface-dim border border-gold/40 flex items-center justify-center">
          ...
          <div>
            ...
            <span className="font-label-sm text-[10px] uppercase tracking-widest text-gold">
        ...
        <div className="space-y-6 text-xs sm:text-sm text-on-surface-variant font-body-md font-light leading-relaxed">
          {type === "legal" ? (
            <>
              <div>
                <h4 className="font-semibold text-gold-light mb-1">Entity Identification & Corporate Structure</h4>
                <p>
              ...
              <div>
                <h4 className="font-semibold text-gold-light mb-1">Nature of Activities</h4>
                <p>
              ...
              <div>
                <h4 className="font-semibold text-gold-light mb-1">Intellectual Property</h4>
                <p>
            ...
            <>
              <div>
                <h4 className="font-semibold text-gold-light mb-1">Swiss Federal Data Protection Compliance</h4>
                <p>
              ...
              <div>
                <h4 className="font-semibold text-gold-light mb-1">Confidential Communication Handling</h4>
                <p>
              ...
              <div>
                <h4 className="font-semibold text-gold-light mb-1">Contact for Privacy Matters</h4>
                <p>
        ...
        <div className="mt-8 pt-4 border-t border-gold/40 flex justify-end">
          <button
            onClick={onClose}
            className="bg-primary hover:bg-primary-container text-on-primary px-6 py-2.5 font-label-sm text-xs uppercase tracking-widest transition-all rounded-sm font-semibold"
          >
            Close
          </button>
        </div>
